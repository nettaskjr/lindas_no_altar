<?php
/**
 * @version $Id: helper.php 76 2016-07-05 10:59:11Z szymon $
...
class DJMediatoolsLayoutHelper extends JObject
{
	...
	public function addLightbox($type, $popup = false) {
		...
		switch($type) {
			...
			case 'slimbox':
				JHTML::_('behavior.framework');
				$document->addStyleSheet(JURI::root(true).'/components/com_djmediatools/assets/slimbox-1.8/js/css/slimbox.css');
