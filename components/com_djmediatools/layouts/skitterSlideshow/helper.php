<?php
/**
 * @version $Id: helper.php 66 2015-09-22 11:22:00Z szymon $
...
class SkitterSlideshowDJMediatoolsLayoutHelper extends DJMediatoolsLayoutHelper {
	...
	public function addScripts(&$params) {
		...
		$document->addStyleSheet('components/com_djmediatools/layouts/skitterSlideshow/css/skitter.styles.min.css');
