...
class DjFlyerViewItems extends JViewLegacy
{
	protected $items;
	...
	{
		JToolBarHelper::title(JText::_('COM_DJFLYER_ITEMS'), 'generic.png');
		...
		JSubMenuHelper::addEntry(JText::_('COM_DJFLYER_ITEMS'), 'index.php?option=com_djflyer&view=items', true);

		JToolBarHelper::addNew('item.add','JTOOLBAR_NEW');
		JToolBarHelper::editList('item.edit','JTOOLBAR_EDIT');
		JToolBarHelper::custom('items.recreateThumbnails','move','move',JText::_('COM_DJFLYER_RECREATE_THUMBNAILS'),true,true);
