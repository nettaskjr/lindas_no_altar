<?php
/**
 * @version $Id: djlicense.php 76 2016-07-05 10:59:11Z szymon $
...
class DJLicense{
	...
	public static function getSubscription(){
		...
		$license_file = JPATH_BASE."/components/".JRequest::getVar('option')."/license_".JFile::makeSafe($config->get('secret')).".txt";
		...
		if(strstr($res[0], 'E')){
			...
			foreach($chver as $r){
				...
				$query = "SELECT manifest_cache FROM #__extensions WHERE name ='".$e[0]."'";
			...
			$update = '<div class="djlic_box">';
				$update .= '<div class="djlic_title">DJ-MediaTools</div>';
