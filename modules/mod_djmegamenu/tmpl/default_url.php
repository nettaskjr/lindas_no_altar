<?php
/**
 * @version $Id: default_url.php 47 2015-12-14 14:43:13Z szymon $
 * @package DJ-MegaMenu
...
if($params->get('icons') > 0 && $params->get('icons') < 3) {
	...
	if(!empty($faicon)) {
		...
		$linktype = '<i class="'.$faicon.'"></i><span class="image-title">'. $item->title . $subtitle .'</span>' :
		$linktype = '&nbsp;<i class="'.$faicon.'"></i>&nbsp;';
