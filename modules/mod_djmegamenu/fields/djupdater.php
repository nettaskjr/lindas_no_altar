...
class JFormFieldDJUpdater extends JFormField
{
	...
	protected function getInput()
	{
		...
		$lang->load('mod_djmegamenu', JPATH_ROOT, null, false, true);
		$lang->load('mod_djmegamenu', JPATH_ROOT . '/modules/mod_djmegamenu', null, false, true);
	...
	public static function getSubscription($ext, $pro){
		...
		$license_file = dirname(__FILE__).'/../license_'.$config->get('secret').'.txt';
						...
						button.click(function(e){
							...
							jQuery.ajax({
								...
								data: {
									...
									install_url: 'http://dj-extensions.com/index.php?option=com_djsubscriptions&view=getUpdate&license=$license&ext=$ext&v=".$version.($pro ? '':'.free')."'
								}
							}).done(function(data) {
